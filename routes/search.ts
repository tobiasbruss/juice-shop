...
export function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    // codeql[js/sql-injection] codeql[js/type-confusion-through-parameter-tampering] - Intentional vulnerabilities for OWASP Juice Shop unionSqlInjectionChallenge and dbSchemaChallenge educational purposes
